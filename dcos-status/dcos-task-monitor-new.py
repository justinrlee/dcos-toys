...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--threshold",
                        help="Specify min threshold to show",
                        default=-1)
    parser.add_argument("-s", "--summarize",
                        help="Summarize marathon",
    ...
    for framework in state['frameworks']:
        ...
        if not args.summarize and framework['name'] == 'marathon':
            ...
            for app in apps:
                if finished_count[app] + failed_count[app] > threshold:
                    print("marathon[{}],{},{}".format(app, finished_count[app], failed_count[app]))
        else:
            if len(finished) > threshold or len(failed) > threshold:
